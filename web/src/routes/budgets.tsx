  ...
  return (
    <div className="bg-cream text-ink">
      ...
      <section className="border-b border-border bg-ink px-6 py-12 text-cream md:px-10">
        <div className="mb-3 text-[10px] uppercase tracking-[0.25em] text-cream/50">Cost Control</div>
        <h1 className="text-4xl font-medium tracking-tight md:text-5xl">Hierarchical budgets</h1>
        <p className="mt-3 max-w-xl text-sm leading-relaxed text-cream/70">
          Set monthly spend caps at the tenant, API-key, and agent levels. Requests are blocked when any limit is exceeded.
        </p>
      </section>
